const translations = {
  en: {
    ...
    ruleScheduleNote: "Applies to the Alpine root crontab only. Weekly is enough for normal rule-set refreshes.",
  ...
  zh: {
    ...
    ruleScheduleNote: "只调整 Alpine root crontab；常规规则刷新每周一次即可，手动立即更新不受影响。",
